...
export var gap_v = 450;
export var gap_h = 150;
export var largest_gen = null;
export var nb_gen = null;
export var family = null;
export var familyGenerations = null;
export var fmCoord = [];
export var fmCoupleCoord = [];
export var fmLineCoord = [];
export var lastCoupleId = 0
export var lastLineId = 0
...
export function getFirst2Initials(name) {
    let w = '';
    if (name) {
...
export function createBallSvgCircle(id, x, y) {
    // let radius = 25;
...
export function openBallMenu(ballDomId) {
...
export function createBallSvgInnerText(id, myname, myphoto=null, isIncomingSpouse, x, y) {
...
export function createBallSvgLowerText(id, myname, x, y) {
...
export function drawLine(id, x1, y1, x2, y2) {
...
export function couple(x1, y1, x2, y2) {
...
export function getById(Tab, id) {
...
export function isFMIncomingSpouse(Tab, id) {
    for (let i = 0; i < Tab.length; i++) {
        if (Tab[i]["id"] == id) {
...
export function getFMIndex(Tab, id) {
    for (let i = 0; i < Tab.length; i++) {
        if (Tab[i]["id"] == id) {
            return i
        }        
...
export function getFMParentIds(Tab, id) {
    for (let i = 0; i < Tab.length; i++) {
        if (Tab[i]["id"] == id) {
...
export function getCoupleByFMIds(Tab, id1, id2) {
    for (let i = 0; i < Tab.length; i++) {
...
export function removeDuplicates(table) {
...
// ////////////////////////////////////////////////////////////////////////////////////
// ////////////////////////////////////////////////////////////////////////////////////
export function initializeSvgZone(viewboxWidth, viewboxHeight) {
...
export function drawCurve(id, startX, startY, endX, endY) {
    let myid = id
...
// export function getFamilyMembers(response) {
